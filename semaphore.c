...
///////////////////////////////////////////////////////////////////////
// Defines for comfortable work with pins for corresponding periphery
///////////////////////////////////////////////////////////////////////
#define SEC 2400000
...
void BOARD_InitPins(void) {
    ...
    NVIC_ClearPendingIRQ(PORTB_PORTC_PORTD_PORTE_IRQn); /* Reset IRQ*/
...
////////////////////////////////////////////////
/**
 * Handler for request from bottom button
 */
void handler_bottom(void) {
    bottom_button = false;
...
/**
 * Handler for request from central button
 */
void handler_central(void) {
...
/**
 * Handler for request from top button
 */
void handler_top(void) {
    top_button = false;
...
/**
 * Handler for request from all buttons at ones
 */
...
/**
 * Handler for request from central and top buttons
 */
...
/**
 * Handler for request from bottom and top buttons
 */
...
/**
 * Handler for request from bottom and central buttons
 */
...
/**
 * Interrupt handler where corresponding flags for button request are set
 */
